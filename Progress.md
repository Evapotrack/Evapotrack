...
4. **Bundle ID** — **BLOCKED**: Apple Developer enrollment stuck on "Pending" (Order W1452447162, March 18, 4+ days elapsed). Support ticket submitted March 22. Do not re-purchase. Once resolved: Register in Certificates, Identifiers & Profiles → Identifiers → App IDs; update Xcode bundle identifier from `Evapotrack.EvapotrackDev` to registered ID (e.g., `com.evapotrack.app`)
